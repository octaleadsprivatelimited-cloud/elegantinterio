  ...
  const contactInfo = [
    {
      icon: Mail,
      title: 'Email',
      details: ['info@elegantinterio.com'],
      action: 'Send Email',
      href: 'mailto:info@elegantinterio.com'
    },
    {
      icon: Phone,
      title: 'Call Us',
      details: ['+91 90103 53837'],
      action: 'Call Now',
      href: 'tel:+919010353837'
    },
    {
      icon: MapPin,
      title: 'Studio Address',
      details: [
        'Road Number 14, Alkapur Township',
      ...
      <section className="relative h-96 flex items-center justify-center overflow-hidden -mt-14 lg:-mt-[96px]">
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          <h1 className="text-4xl lg:text-6xl font-bold mb-6 leading-tight">
            Connect with <span className="text-accent">Elegant Interio</span>
          </h1>
          <p className="text-xl lg:text-2xl text-white/90 mb-8 leading-relaxed">
            Ready to transform your space? Visit our Hyderabad studio or schedule a consultation to
            bring your next residential or commercial project to life.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              <div className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Meet the Elegant Interio team at our Hyderabad studio to explore material boards,
                  discuss floor plans, and co-create your next project in person.
                </p>
              </div>
