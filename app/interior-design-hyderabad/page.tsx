...
export const metadata: Metadata = {
  title: 'Interior Designers in Hyderabad | Elegant Interio',
  description:
    'Elegant Interio designs bespoke residential and commercial interiors across Hyderabad. Visit our studio in Alkapur Township, Puppalguda to explore luxury concepts, 3D visualisations, and turnkey execution.',
  keywords: [
