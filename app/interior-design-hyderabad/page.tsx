...
import { ArrowRight, MapPin, Star, CheckCircle, Home, Building, Users, Award } from 'lucide-react';

export const metadata: Metadata = {
  title: 'Best Interior Designers in Hyderabad | Elegant Interio | Luxury Home & Office Interiors',
  description:
  ...
  openGraph: {
    ...
    description: 'Hyderabad\'s premier interior design company. Award-winning luxury residential & commercial interiors. 60+ projects. Free consultation.',
    type: 'website',
    locale: 'en_IN',
    images: [{ url: 'https://elegantinterio.com/logo-white.png', alt: 'Interior Designers Hyderabad' }],
  },
  alternates: {
    canonical: 'https://elegantinterio.com/interior-design-hyderabad',
  },
};
    ...
    <div className="min-h-screen">
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl lg:text-2xl text-gray-200 mb-8 max-w-3xl mx-auto">
              Transform your space with Elegant Interio—Hyderabad&apos;s boutique studio for luxury
              residential and commercial interiors tailored to your lifestyle and brand.
            </p>
      ...
      <section className="py-20">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Why Choose Elegant Interio in Hyderabad?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
      ...
      <section className="py-20 bg-gradient-to-r from-primary-900 to-accent-900 text-white">
        <div className="container-custom text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Get a free consultation with Elegant Interio&apos;s award-winning designers in Hyderabad.
